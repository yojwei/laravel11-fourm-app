...
const menu = [
    {
        ...
        url: route('dashboard'),
        root: 'dashboard',
        when: () => usePage().props.auth.user != null,
    },
    {
        name: 'Posts',
            ...
            <nav class="bg-white border-b border-gray-100">
                        ...
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <template v-for="item in menu" :key="item.name">
                                    <NavLink v-if="item.when()" :href="item.url" :active="route().current(item.root)">
                                        {{ item.name }}
                                    </NavLink>
                                </template>
                        ...
                        <div class="hidden sm:flex sm:items-center sm:ms-6">
                            ...
                            <div class="ms-3 relative">
                                <Dropdown align="right" width="48">
                                    <template #trigger v-if="$page.props.auth.user != null">
                ...
                <div :class="{ 'block': showingNavigationDropdown, 'hidden': !showingNavigationDropdown }"
                    ...
                    <div class="pt-4 pb-1 border-t border-gray-200">
                        <div class="flex items-center px-4" v-if="$page.props.auth.user != null">
